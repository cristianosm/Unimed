...
Gerado em        06/22/16 14:16:52
Observações      Código-Fonte gerado por ADVPL WSDL Client 1.120703
                 Alterações neste arquivo podem causar funcionamento incorreto
                 e serão perdidas caso o código-fonte seja gerado novamente.
=============================================================================== */

User Function _PGPHQUQ ; Return  // "dummy" function - Internal Use
...
oXmlRet := SvcSoapCall(	Self,cSoap,;
	"",;
	"DOCUMENT","http://services.soc.syson.com.br/",,,;
	"http://sys-on.com.br:8080/SocWebService/VS?xsd=1")//http://sys-on.com.br:8080/SocWebService/VS?xsd=1
